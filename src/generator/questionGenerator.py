...
from src.models.questionSchema import McqQuestion,FillBlankQuestion
from src.prompts.templates import mcq_prompt_template,fill_blank_prompt_template
from src.llm.groqClient import get_groq_llm
from src.config.settings import settings
from src.common.logger import get_logger
from src.common.customException import CustomException
...
class QuestionGenerator:
    ...
    def _retry_and_parse(self,prompt,parser,topic,difficulty):
        ...
        for attempt in range(settings.MAX_RETRIES):
            try:
                ...
                self.logger.info("Succussfully parsed the question")
    ...
    def generate_fill_blank(self,topic:str,difficulty:str='medium')->FillBlankQuestion:
            ...
            try:
                ...
                self.logger.info("Generated a valid Fill the blank question")

                return question
            
            except Exception as e:
                self.logger.error(f"Failed to generate Fill the blank question {str(e)}")

                raise CustomException("Fill the blank question Generation Failed",e)
